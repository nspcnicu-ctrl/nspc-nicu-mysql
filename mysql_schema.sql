-- =============================================================================
-- NSPC RSUD UNDATA - MYSQL DATABASE SCHEMA (NIAGAHOSTER / CPANEL COMPATIBLE)
-- =============================================================================
-- Karakter Set: UTF8MB4 (Mendukung teks Indonesia & Emoji medis)
-- Engine: InnoDB (Mendukung Transaksi, Index B-Tree, & Foreign Keys ON DELETE CASCADE)
-- =============================================================================
...
CREATE TABLE IF NOT EXISTS `patients` (
  ...
  -- Struktur JSON untuk Data Antropometri, Alat Medis, Milestone, Skrining, dan Ringkasan Pulang
  ...
  -- Indexing untuk pencarian cepat & otentikasi orang tua
...
-- =============================================================================
-- SEED DATA AWAL (DEFAULT SUPER ADMIN & SAMPLE MATERI EDUKASI)
-- =============================================================================
